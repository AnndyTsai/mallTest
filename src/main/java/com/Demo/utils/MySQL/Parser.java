...
public class Parser {
    ...
    public static void main(String... args) {
    	...
    	System.out.println(Parser.parse1("我的名字是{xx}，我爸爸的名字是{xx},我妈妈的名字是{xx}", "雷锋","bab","mam"));
    	
        System.out.println(Parser.parse0("我的名字是${xx}", "雷锋"));

        System.out.println(Parser.parse1("我的名字是{}", "雷锋"));
